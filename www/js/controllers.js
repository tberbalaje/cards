...
angular.module('starter.controllers', ['angularGrid', 'ionic', 'angularMoment', 'ionic-toast', 'ngMaterial'])



  .controller('DashCtrl', ['$scope', 'imageService', 'angularGridInstance', '$ionicModal', 'ionicToast', '$http', '$ionicPopup', '$filter', '$q', function($scope, imageService, angularGridInstance, $ionicModal, ionicToast, $http, $ionicPopup, $filter, $q ) {
...
//     console.log('Page ' + vm.page + ' loaded:');
//     console.log(data);
...
vm.loadingMore = true;
var promise = $http.jsonp("https://api.flickr.com/services/feeds/photos_public.gne?format=json&jsoncallback=JSON_CALLBACK");
promise.then(function(data) {
console.log('Page ' + vm.page + ' loaded:');
console.log(data);
var shotsTmp = angular.copy(vm.shots);
shotsTmp = shotsTmp.concat(data.data.items);
vm.shots = shotsTmp;
vm.loadingMore = false;
$scope.$broadcast('scroll.infiniteScrollComplete');
}, function() {
